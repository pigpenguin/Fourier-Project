...
\end{equation}
of complex exponentials. From here we see that squaring any element in \eqref{ex} simply doubles the value of $k$. Squaring an element three times will eventually yield
\begin{equation*}
