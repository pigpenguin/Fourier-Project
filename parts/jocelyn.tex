...
\begin{document}
  ...
  domain into a frequency domain\cite{smith_1997}.
  The Fourier Transform
  in image processing allows us to access the geometric
  characteristics of an image
  \cite{fisher_perkins_walker_wolfart_2003}. By having access to the
  ...
  in the frequency domain \cite{smith_1997}.
  Therefore, applying filters
