...
\begin{definition}
Let $\mathbb{Z}(N)$ be the set of all N-th roots of unity. Then, $Z(N) = \{z \in C : z^N = 1 \}.$
\end{definition}
\begin{theorem}
For all $N$ $\in$ $\mathbb{Z}$, we have that $\mathbb{Z}(N)= \{1, e^{(2 \pi i)/N}, e^{(4 \pi i)/N}, ..., e^{(2(N-1) \pi i)/N}$
\end{theorem}
...
Values of the Legendere Chi and Hurwitz Zeta Functions at Rational Arguments: Dujurdje Cvijovic, Jacek Klinowski (1999).\newline
http://www.ams.org/journals/mcom/1999-68-228/S0025-5718-99-01091-1/S0025-5718-99-01091-1.pdf
